...
export function EnhancedMapExplorer({
  ...
  return (
    <div className="relative h-[calc(100vh-5rem)] w-full overflow-hidden">
        ...
        {showSidebar && (
          ...
          >
            <div className="p-4 border-b border-gray-800">
              ...
              <form onSubmit={handleSearchSubmit} className="mb-4">
                <div className="relative">
                  ...
                  <Button
                    type="submit"
                    size="sm"
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-purple-600 hover:bg-purple-700 text-white h-8 px-3"
                  >
                    Search
                  </Button>
                </div>
                ...
                <div className="flex items-center">
                  {userLocation ? (
                    <>
                      ...
                      <span className="text-sm text-gray-300 truncate max-w-[200px]">{userLocationName}</span>
                    </>
                  ) : (
                    <span className="text-sm text-gray-400">No location selected</span>
                  )}
                </div>
                <Button
                  variant="outline"
              ...
              {locationError && (
                <div className="mb-4 p-2 bg-red-900/30 border border-red-800 rounded-md text-sm text-red-300 flex items-start">
              ...
              <div className="mb-4">
                <div className="flex items-center justify-between mb-2">
                  <label className="text-sm text-gray-300">Search Radius: {searchRadius} miles</label>
                </div>
                <Slider
                  value={[searchRadius]}
                  min={5}
            ...
            <Tabs defaultValue="list" className="flex-1 flex flex-col">
              <TabsList className="grid grid-cols-2 bg-[#22252F] rounded-none border-b border-gray-800">
                <TabsTrigger value="list" className="data-[state=active]:bg-[#1A1D25] rounded-none">
                  List View
                </TabsTrigger>
                <TabsTrigger value="filters" className="data-[state=active]:bg-[#1A1D25] rounded-none">
                  Filters
                </TabsTrigger>
              </TabsList>

              {/* List View */}
              <TabsContent value="list" className="flex-1 flex flex-col p-0">
                {/* Category filters */}
                <div className="p-4 border-b border-gray-800">
                ...
                <div className="p-4 border-b border-gray-800">
                  <div className="flex items-center justify-between">
                    ...
                    <Select value={sortBy} onValueChange={setSortBy}>
                      <SelectTrigger className="w-[140px] h-8 text-sm bg-[#22252F] border-gray-700">
              ...
              {/* Filters View */}
              <TabsContent value="filters" className="flex-1 overflow-y-auto p-4 space-y-6">
                {/* Price Range */}
                <div>
                  ...
                  <div className="flex justify-between text-sm text-gray-400">
                    <span>${Math.floor((priceRange[0] / 100) * 1000)}</span>
                    <span>${Math.floor((priceRange[1] / 100) * 1000)}+</span>
                  </div>
                </div>
                ...
                <div>
                  <div className="flex items-center justify-between">
                    <Label htmlFor="free-events" className="text-sm text-gray-300">
                      Free events only
                    </Label>
                    <Switch
                      id="free-events"
                ...
                {/* Map Options */}
                <div>
                  <h3 className="text-sm font-medium text-gray-300 mb-3">Map Options</h3>

                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <Label htmlFor="3d-buildings" className="text-sm text-gray-300">
                        3D Buildings
                      </Label>
                      <Switch
                        id="3d-buildings"
                    ...
                    <div className="flex items-center justify-between">
                      <Label htmlFor="terrain" className="text-sm text-gray-300">
                        Terrain
                      </Label>
                      <Switch
                        id="terrain"
                    ...
                    <div className="flex items-center justify-between">
                      <Label htmlFor="clusters" className="text-sm text-gray-300">
                        Cluster Markers
                      </Label>
                      <Switch
                        id="clusters"
                ...
                {/* Map Style */}
                <div>
                  <h3 className="text-sm font-medium text-gray-300 mb-3">Map Style</h3>

                  <div className="grid grid-cols-3 gap-2">
                    <Button
                      variant="outline"
                      className={cn(
                        "border-gray-700 text-gray-300 hover:text-white hover:border-gray-600 flex flex-col items-center justify-center h-20",
                        mapStyle === "dark-v11" && "border-purple-500 bg-purple-900/20",
                      )}
                      onClick={() => setMapStyle("dark-v11")}
                    >
                      <div className="h-8 w-8 rounded-full bg-gray-800 border border-gray-600 mb-2"></div>
                    ...
                    <Button
                      ...
                      className={cn(
                        "border-gray-700 text-gray-300 hover:text-white hover:border-gray-600 flex flex-col items-center justify-center h-20",
                        mapStyle === "light-v11" && "border-purple-500 bg-purple-900/20",
                      )}
                      onClick={() => setMapStyle("light-v11")}
                    >
                      <div className="h-8 w-8 rounded-full bg-gray-200 border border-gray-300 mb-2"></div>
                    ...
                    <Button
                      ...
                      className={cn(
                        "border-gray-700 text-gray-300 hover:text-white hover:border-gray-600 flex flex-col items-center justify-center h-20",
                        mapStyle === "satellite-streets-v12" && "border-purple-500 bg-purple-900/20",
                      )}
                      onClick={() => setMapStyle("satellite-streets-v12")}
                    >
                      <div className="h-8 w-8 rounded-full bg-blue-900 border border-blue-700 mb-2"></div>
      ...
      <AnimatePresence>
        {locationPermissionRequested && locationPermissionStatus === "prompt" && !userLocation && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          >
            ...
            >
              ...
              <h2 className="text-xl font-bold text-white text-center mb-2">Share Your Location</h2>
              <p className="text-gray-300 text-center mb-6">
                Allow DateAI to access your location to find events near you. We'll only use your location to show
                relevant events.
              </p>
              <div className="flex flex-col gap-3">
                <Button className="bg-purple-600 hover:bg-purple-700 text-white" onClick={promptForLocation}>
                  Allow Location Access
                </Button>
                <Button
                  variant="outline"
                  className="border-gray-700 text-gray-300 hover:text-white"
                  onClick={() => setLocationPermissionRequested(false)}
                >
                  Not Now
                </Button>
              </div>
