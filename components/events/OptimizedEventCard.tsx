...
export function OptimizedEventCard({
  event,
  onSelect,
  className,
  index = 0,
  ...
  const OptimizedImage = ({ className: imgClassName }: { className?: string }) => (
  ...
  // Default variant with optimizations
  return (
    <motion.div
    ...
    >
      <Card className="bg-[#1A1D25]/80 backdrop-blur-md border border-gray-800/50 hover:border-purple-500/50 transition-all duration-300 overflow-hidden group-hover:shadow-2xl group-hover:shadow-purple-500/20">
        <div className="relative h-48 overflow-hidden">
          <OptimizedImage className="group-hover:scale-110" />
