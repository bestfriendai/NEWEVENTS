            ...
            <div className="md:col-span-3">
              <div className="bg-[#1A1D25]/60 backdrop-blur-sm border border-gray-800/50 rounded-xl p-6">
                ...
                <TabsContent value="privacy" className="mt-0 space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-[#22252F] border border-gray-800 rounded-lg p-4">
                      <h3 className="text-md font-medium text-white mb-3">Profile Visibility</h3>
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center justify-between">
                          <Label htmlFor="showActivity" className="text-gray-300 cursor-pointer">
                ...
                <TabsContent value="billing" className="mt-0 space-y-6">
                  <div>
                    <h2 className="text-xl font-medium text-white mb-1">Billing Settings</h2>
                  ...
                  <div className="space-y-4">
                    <div className="bg-[#22252F] border border-gray-800 rounded-lg p-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-gray-300 text-sm">Premium Plan</p>
                          <p className="text-gray-500 text-xs">$9.99/month • Next billing: Jan 15, 2024</p>
                        </div>
                        <Button
                          variant="outline"
                          size="sm"
                          className="bg-[#1A1D25] hover:bg-[#22252F] text-gray-300 border-gray-700"
                        >
                          Manage Plan
                        </Button>
                      </div>
